    ...
    public static function allproductosimple()
    {
        ...
        do {
            ...
            if ($countproductossimples > 0) {
                ...
                collect($productossimple['data']['productos'])->chunk(100)->each(function ($chunk) {
                    try {
                        $dataToInsert = [];
                        foreach ($chunk as $productoSimple) {
                        ...
                        ProductoSimple::insert($dataToInsert);
                    } catch (\Exception $e) {
